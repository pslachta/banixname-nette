<?php
// source: /home/banix/www/banixname-nette/app/config/config.neon 
// source: /home/banix/www/banixname-nette/app/config/config.local.neon 
...
class SystemContainer extends Nette\DI\Container
{
	...
	public function __construct()
	{
		parent::__construct(array(
			'appDir' => '/home/banix/www/banixname-nette/app',
			'wwwDir' => '/home/banix/www/banixname-nette/www',
			'debugMode' => TRUE,
			...
			'tempDir' => '/home/banix/www/banixname-nette/app/../temp',
		));
	}
	...
	{
		$service = new Nette\Caching\Storages\FileStorage('/home/banix/www/banixname-nette/app/../temp/cache', $this->getService('nette.cacheJournal'));
		return $service;
	}
	...
	{
		$service = new Nette\Caching\Storages\FileJournal('/home/banix/www/banixname-nette/app/../temp');
		return $service;
	}
	...
	public function createServiceNette__latte()
	{
		...
		$service->setTempDirectory('/home/banix/www/banixname-nette/app/../temp/cache/latte');
	...
	{
		$service = new Nette\Application\PresenterFactory('/home/banix/www/banixname-nette/app', $this);
	...
	{
		$service = new Nette\Caching\Storages\PhpFileStorage('/home/banix/www/banixname-nette/app/../temp/cache', $this->getService('nette.cacheJournal'));
