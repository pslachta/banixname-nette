<?php
// source: /home/banix/www/banixname-nette/app/templates/@layout.latte

// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('1340937264', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block head
//
if (!function_exists($_b->blocks['head'][] = '_lb3950940f19_head')) { function _lb3950940f19_head($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
;
}}
...
// block scripts
//
if (!function_exists($_b->blocks['scripts'][] = '_lb3bc4c59571_scripts')) { function _lb3bc4c59571_scripts($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
