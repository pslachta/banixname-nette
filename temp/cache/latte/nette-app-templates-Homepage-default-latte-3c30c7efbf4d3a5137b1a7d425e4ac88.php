<?php
// source: /home/banix/www/banixname-nette/app/templates/Homepage/default.latte

// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('3737425719', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block content
//
if (!function_exists($_b->blocks['content'][] = '_lba99e4d64a5_content')) { function _lba99e4d64a5_content($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
?><div id="banner">
...
// block title
//
if (!function_exists($_b->blocks['title'][] = '_lb2faf281e4d_title')) { function _lb2faf281e4d_title($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
...
// block scripts
//
if (!function_exists($_b->blocks['scripts'][] = '_lb4890dab2b8_scripts')) { function _lb4890dab2b8_scripts($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
...
// block head
//
if (!function_exists($_b->blocks['head'][] = '_lb4719c6ed16_head')) { function _lb4719c6ed16_head($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
?><style>
